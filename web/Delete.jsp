...
<html>
    ...
    <body id="body">
    <center>  
        <h1 id="mainHeading">Delete Form</h1>
        ...
        <table border="2" width="100%">  
            ...
            <form method="post">
                <table>
                    <tr>
                        <th id="headings">Enter the Roll Number </th>
                        <td><input type="text" name="roll" size="25"></td>
                    </tr>
                    <tr>
                       
                        <td><form method="post"><input type="Submit" value="Home" formaction="index.html"></form></td>
                         <td><input type="Submit" value="Delete" formaction="Deleted.jsp"></td>
                    </tr>
                </table>
            </form>
